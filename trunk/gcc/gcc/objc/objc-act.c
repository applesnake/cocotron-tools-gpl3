...
static int flag_objc_abi=1;
static int flag_objc_gc_only=0;
static int flag_objc2_check=0;
static int warn_property_assign_default=0;
static int print_objc_ivar_layout=0;
static int flag_objc_zerocost_exceptions=0;
static int flag_objc_nilcheck=0;
...
synth_module_prologue (void)
{
  ...
  if (flag_objc_msgsend)
      ...
      if (flag_objc_abi == 2)
	{
	  ...
	  umsg_fpret_fixup_decl = add_builtin_function ("objc_msgSend_fpret_fixup",
					      type, 0, NOT_BUILT_IN,
					      NULL, NULL_TREE);
	  ...
	  TREE_NOTHROW (umsg_id_super2_fixup_decl) = 0;
          ...
          umsg_id_super2_stret_fixup_decl = add_builtin_function ("objc_msgSendSuper2_stret_fixup",
      ...
      /* Not needed for ppc */
      umsg_fpret_decl = add_builtin_function (TAG_MSGSEND_FPRET,
				          type, 0, NOT_BUILT_IN,
					  NULL, NULL_TREE);
	...
	{
          umsg_decl = add_builtin_function (TAG_MSGSEND_FAST,
					     type, 0, NOT_BUILT_IN,
					     NULL, NULL_TREE);
          TREE_NOTHROW (umsg_decl) = 0;
...
{
// This is generating objc_assign_ivar erroneously and we dont support write barriers anyway.
  return NULL;
...
build_next_objc_exception_stuff (void)
{
  ...
  objc_exception_extract_decl
    = add_builtin_function (TAG_EXCEPTIONEXTRACT, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
  ...
  objc_exception_try_enter_decl
    = add_builtin_function (TAG_EXCEPTIONTRYENTER, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
  objc_exception_try_exit_decl
    = add_builtin_function (TAG_EXCEPTIONTRYEXIT, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
  ...
  objc_exception_match_decl
    = add_builtin_function (TAG_EXCEPTIONMATCH, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
  ...
  objc_assign_ivar_decl
    ...
    {
      objc_assign_ivar_decl
	= add_builtin_function (TAG_ASSIGNIVAR, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
    }
  /* APPLE LOCAL end radar 4590221 */
  ...
  objc_assign_global_decl
	= add_builtin_function (TAG_ASSIGNGLOBAL, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
  objc_assign_strong_cast_decl
	= add_builtin_function (TAG_ASSIGNSTRONGCAST, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
  /* APPLE LOCAL begin radar 4426814 */
  /* id objc_assign_weak (id, id *); */
  objc_assign_weak_decl
	= add_builtin_function (TAG_ASSIGN_WEAK, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
  ...
  /* APPLE LOCAL radar 4591756 */
  objc_read_weak_decl
	= add_builtin_function (TAG_READ_WEAK, temp_type, 0, NOT_BUILT_IN, NULL, NULL_TREE);
  /* APPLE LOCAL end radar 4426814 */
  /* APPLE LOCAL begin radar 3742561 */
  ...
  objc_memmove_collectable_decl
	= add_builtin_function (TAG_MEMMOVE_COLLECTABLE, temp_type, 0, 
			    NOT_BUILT_IN, NULL, NULL_TREE);
  /* APPLE LOCAL end radar 3742561 */
}
  ...
  if (flag_objc_zerocost_exceptions)
    {
      ...
      type
        = build_function_type (void_type_node, OBJC_VOID_AT_END);
      objc_rethrow_exception_decl = add_builtin_function ("objc_exception_rethrow",
                                               type, 0, NOT_BUILT_IN,
                                               NULL, NULL_TREE);

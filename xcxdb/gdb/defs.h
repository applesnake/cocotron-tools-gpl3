...
/* APPLE LOCAL additional cleanups */
struct cleanup *make_cleanup_set_restore_scheduler_locking_mode (enum scheduler_locking_mode new_mode);

struct ui_out; /* forward struct */
struct cleanup *make_cleanup_restore_uiout (struct ui_out *old_uiout);

struct cleanup *make_exec_error_cleanup (make_cleanup_ftype *, void *);
void discard_exec_error_cleanups (struct cleanup *);
void do_exec_cleanups (struct cleanup *);
